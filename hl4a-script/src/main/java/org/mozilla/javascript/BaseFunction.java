...
// #generated# Last update: 2007-05-09 08:15:15 EDT
		L0:
		{
			...
			switch (s.length()) {
				case 4:
					X = "name"; id = Id_name; break L;
				case 5:
					X = "arity"; id = Id_arity; break L;
				case 6:
					X = "length"; id = Id_length; break L;
				case 9:
					c = s.charAt(0);
					if (c == 'a') { X = "arguments"; id = Id_arguments; } else if (c == 'p') {
						X = "prototype"; id = Id_prototype;
					}
					break L;
			}
...
// #/string_id_map#
	...
	protected void initPrototypeId(int id) {
		...
		switch (id) {
			...
			case Id_apply:
				arity = 2; s = "apply"; break;
			case Id_call:
				arity = 1; s = "call"; break;
			case Id_bind:
				arity = 1; s = "bind"; break;
			default:
...
// #generated# Last update: 2009-07-24 16:00:52 EST
		L0:
		{
			...
			switch (s.length()) {
				case 4:
					c = s.charAt(0);
					if (c == 'b') { X = "bind"; id = Id_bind; } else if (c == 'c') { X = "call"; id = Id_call; }
					break L;
				case 5:
					X = "apply"; id = Id_apply; break L;
				case 8:
					c = s.charAt(3);
