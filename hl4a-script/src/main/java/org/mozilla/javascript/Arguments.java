...
// #generated# Last update: 2010-01-06 05:48:21 ARST
		L0:
		{
			...
			if (s_length == 6) {
				c = s.charAt(5);
				if (c == 'e') { X = "callee"; id = Id_callee; } else if (c == 'h') {
					X = "length"; id = Id_length;
...
// #/generated#
	...
	protected Object getInstanceIdValue(int id) {
		switch (id) {
			...
			case Id_caller: {
				...
				if (value == UniqueTag.NULL_VALUE) { value = null; } else if (value == null) {
	...
	protected void setInstanceIdValue(int id, Object value) {
		switch (id) {
			case Id_callee:
				calleeObj = value; return;
			case Id_length:
				lengthObj = value; return;
			case Id_caller:
	...
	protected void setInstanceIdAttributes(int id, int attr) {
		switch (id) {
			case Id_callee:
				calleeAttr = attr; return;
			case Id_length:
				lengthAttr = attr; return;
			case Id_caller:
				callerAttr = attr; return;
		}
