...
public class ScriptRuntime {
	...
	public static Object applyOrCall(boolean isApply,
		...
		if (L != 0) {
			if (cx.hasFeature(Context.FEATURE_OLD_UNDEF_NULL_THIS)) {
				...
				callThis = args[0] == Undefined.instance ? Undefined.SCRIPTABLE_UNDEFINED : toObjectOrNull(cx, args[0]
						, scope);
			}
		}
	...
	private static void warnAboutNonJSObject(Object nonJSObject) {
		...
		if (!"true".equals(omitParam)) {
			String message = ScriptRuntime.getMessage2("msg.non.js.object.warning", nonJSObject,
