...
// #generated# Last update: 2007-08-20 09:01:10 EDT
		L0:
		{
			...
			switch (s.length()) {
				case 12:
					X = "prettyIndent"; id = Id_prettyIndent; break L;
				case 14:
					c = s.charAt(0);
					if (c == 'i') { X = "ignoreComments"; id = Id_ignoreComments; } else if (c == 'p') {
						X = "prettyPrinting"; id = Id_prettyPrinting;
					}
					break L;
				case 16:
					X = "ignoreWhitespace"; id = Id_ignoreWhitespace; break L;
				case 28:
					X = "ignoreProcessingInstructions"; id = Id_ignoreProcessingInstructions; break L;
			}
...
// #generated# Last update: 2007-08-20 09:01:10 EDT
		L0:
		{
			...
			if (s_length == 8) { X = "settings"; id = Id_settings; } else if (s_length == 11) {
				X = "setSettings"; id = Id_setSettings;
...
// #/string_id_map#
	...
	protected void initPrototypeId(int id) {
		...
		switch (id) {
			...
			case Id_settings:
				arity = 0; s = "settings"; break;
			case Id_setSettings:
				arity = 1; s = "setSettings"; break;
			default:
